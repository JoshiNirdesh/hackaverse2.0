...
const InvestorRegistration = () => {
  ...
  const sectors = [
    'AI/ML', 'HealthTech', 'EdTech', 'Agriculture & Food', 'Education',
    'Healthcare', 'Technology', 'Tourism', 'Manufacturing', 'Finance',
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            <div className="form-labels">
              ...
              <textarea name="investmentExperience" value={formData.investmentExperience} onChange={handleChange} placeholder="e.g., 5+ years" />
